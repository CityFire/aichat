            ...
            st.markdown(f"""
                <div class="brand-section">
                    ...
                    <div class="brand-text">
                        <h1 class="brand-header">SmartAI</h1>
            ...
            st.markdown("""
                <div class="chat-message assistant-message">
                    ...
                    <div class="message-content">
                        👋 Hello! I'm your Sweet and Smart AI assistant. How can I help you with coding today?
                    </div>
                </div>
            """, unsafe_allow_html=True)
